...
def validations():
    ...
    if name.get() == "":
        ...
        messagebox.showinfo("Alert","Enter Age first")
    elif gender.get() ==0:
    ...
    if (x == 1):
    	...
    	gmail_user = "vinaypatil7454@gmail.com"
    	gmail_pwd = "Vinu@123"
    	#getting subject input from sender
...
Button(win, text='Submit',width=10,bg='blue',fg='white',command  = validations).place(x=180,y=730)
Button(win, text='Clear Data',width=10,bg='blue',fg='white',command = clear).place(x=50,y=730)
Button(win, text='Check',width=10,bg='blue',fg='white',command = view).place(x=320,y=730)
